    ...
    <div class="container-fluid pt-4">
        <div class="row">
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                @if (session('catgory_Update_message'))
                ...
                <div class="card card-body bg-dark text-white border-0 shadow-sm p-4"
                    ...
                    <h4 class="mb-4 text-uppercase tracking-wider" style="color: #db6574; font-weight: 600;">Update Category
                    </h4>

                    <form action="{{ route('admin.postcategoryupdate', $category->id) }}" method="Post">
                        @csrf

                        <div class="form-group mb-4">
                            <label for="category" class="form-label text-muted mb-2">Category Name</label>
                            <input type="text" id="category" name="category"
                                class="form-control text-white border-secondary" value="{{ $category->category }}"
